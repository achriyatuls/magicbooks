...
import '../../../module/efd1300_string/tests/efd1300_tests.dart';

Widget rowLabelValidatedEfd1300(int exerciseNumber) {
  TestResult result = Efd1300Validator.runTest(exerciseNumber);

  return InkWell(
    onTap: () => showTestResultDialogEfd1300(result),
    child: Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          _buildStatusIconEfd1300(result),
        ],
      ),
    ),
  );
...
Widget _buildStatusIconEfd1300(TestResult result) {
  if (result.isPerfect) {
...
void showTestResultDialogEfd1300(TestResult result) {
  showDialog(
