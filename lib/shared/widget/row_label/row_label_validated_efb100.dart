...
import '../../../module/efb100_null_safety/tests/efb100_tests.dart';

Widget rowLabelValidatedEfb100(int exerciseNumber) {
  TestResult result = Efb100Validator.runTest(exerciseNumber);

  return InkWell(
    onTap: () {
      showTestResultDialogEfb100(result);
    },
    child: Padding(
...
Widget _buildStatusIconEfb100(TestResult result) {
  if (result.isPerfect) {
    return const Icon(
      Icons.check_circle,
      color: Colors.green,
...
void showTestResultDialogEfb100(TestResult result) {
  showDialog(
