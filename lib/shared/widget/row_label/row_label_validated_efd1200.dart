...
import '../../../module/efd1200_datetime/tests/efd1200_tests.dart';

Widget rowLabelValidatedEfd1200(int exerciseNumber) {
  TestResult result = Efd1200Validator.runTest(exerciseNumber);

  return InkWell(
    onTap: () => showTestResultDialogEfd1200(result),
    child: Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          _buildStatusIconEfd1200(result),
        ],
      ),
    ),
  );
...
Widget _buildStatusIconEfd1200(TestResult result) {
  if (result.isPerfect) {
...
void showTestResultDialogEfd1200(TestResult result) {
  showDialog(
